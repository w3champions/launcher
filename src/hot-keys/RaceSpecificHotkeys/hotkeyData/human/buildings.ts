...
const buildings =
    [
        ...
        new Building('Lumber Mill', 'btnhumanlumbermill',
            buildingWithCancel([
                Ability.Create('Upgrade Lumber Harvesting', 'btnhumanlumberupgrade1', 'rhlh', 'L', []),
                Ability.Create('Upgrade Masonry', 'btnstonearchitecture', 'rhac', 'M', []),
                ...Ability.Defaults(9),
            ])),
        new Building('Blacksmith', 'btnblacksmith',
            buildingWithCancel([
                Ability.Create('Upgrade Forged Swords', 'btnsteelmelee', 'rhme', 'S', []),
                Ability.Create('Upgrade Gunpowder', 'btnhumanmissileupone', 'rhra', 'G', []),
                ...Ability.Defaults(2),
                Ability.Create('Upgrade Plating', 'btnhumanarmorupone', 'rhar', 'P', []),
                Ability.Create('Upgrade Leather Armor', 'btnleatherupgradeone', 'rhla', 'A', []),
                ...Ability.Defaults(5),
            ])),
        ...
        new Building('Arcane Sanctum', 'btnarcanesanctum',
            buildingWithCancel([
                ...
                rally,
                Ability.Create('Sorceress Training', 'btnsorceressadept', 'rhst', 'O', []),
                Ability.Create('Priest Training', 'btnpriestadept', 'rhpt', 'T', []),
