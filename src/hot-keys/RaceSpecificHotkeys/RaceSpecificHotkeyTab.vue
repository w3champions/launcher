...
.undead-btnabomination {
  background: url('~@/assets/images/hotkeys/icons/undead/btnabomination.jpg') no-repeat center;
  background-size: cover;
}

.undead-btnacolyte {
  background: url('~@/assets/images/hotkeys/icons/undead/btnacolyte.jpg') no-repeat center;
  background-size: cover;
}

.nightelf-btnarcher {
  background: url('~@/assets/images/hotkeys/icons/nightelf/btnarcher.jpg') no-repeat center;
  background-size: cover;
}

.neutral-btnacidbomb {
  background: url('~@/assets/images/hotkeys/icons/neutral/btnacidbomb.jpg') no-repeat center;
  background-size: cover;
}
